...
urlpatterns = [
    ...
    path('reporte-tanner/a-omega/lista/', views.TannerOmegaReportListView.as_view(), name='tanner_omega_list'),
    path('reporte-tanner/a-omega/<int:pk>/descargar/', views.TannerOmegaReportDownloadView.as_view(), name='tanner_omega_download'),
